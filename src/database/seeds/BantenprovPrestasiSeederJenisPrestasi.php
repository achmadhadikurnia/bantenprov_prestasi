 ...
 * [2] $ php artisan db:seed --class=BantenprovPrestasiSeederJenisPrestasi
 */
class BantenprovPrestasiSeederJenisPrestasi extends Seeder
{
    ...
    protected $fileName = "BantenprovPrestasiSeederJenisPrestasi.csv";
