 ...
 * [2] $ php artisan db:seed --class=BantenprovTingkat
 */
class BantenprovTingkat extends Seeder
{
    /* text color */
    ...
    protected $fileName = "BantenprovTingkat.csv";
    ...
    public function __construct(){
        $this->model = new Bantenprov\Prestasi\Models\Bantenprov\Prestasi\Tingkat;
    }
    /**
